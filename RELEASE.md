...
- `ghcr.io/fe-spark/ecohub-server:v1.1.5-beta.1`
- `ghcr.io/fe-spark/ecohub-web:v1.1.5-beta.1`
...
#   image: ghcr.io/fe-spark/ecohub-server:v1.1.5-beta.1
#   image: ghcr.io/fe-spark/ecohub-web:v1.1.5-beta.1
# 1. 停自动采集 / 定时采集
