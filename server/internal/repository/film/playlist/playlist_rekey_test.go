...
func TestSlavePlaylistRekeyTargets_OnlyUniqueMasterMatch(t *testing.T) {
	...
	dbidKey := shared.BuildMovieMatchKeys(111, "仙逆")[0]
	catKey20 := shared.BuildMovieMatchKeysWithCategory(0, "仙逆", 20)[0]
	catKey30 := shared.BuildMovieMatchKeysWithCategory(0, "仙逆", 30)[0]
	plainKey := shared.BuildMovieMatchKeys(0, "仙逆")[0]
	onlyKey := shared.BuildMovieMatchKeysWithCategory(0, "独苗", 20)[0]
	...
	createTestFilmWithKeys(t, gdb, 903, "独苗", 20, 0, []string{onlyKey, shared.BuildMovieMatchKeys(0, "独苗")[0]})
...
func TestSlavePlaylistRekeyTargets_DoesNotMergeOntoSharedTitle(t *testing.T) {
	...
	cat20 := shared.BuildMovieMatchKeysWithCategory(0, "仙逆", 20)[0]
	cat34 := shared.BuildMovieMatchKeysWithCategory(0, "仙逆", 34)[0]
	plain := shared.BuildMovieMatchKeys(0, "仙逆")[0]
...
func TestMigrateSlavePlaylistKeys_DryRunThenApply(t *testing.T) {
	...
	staleKey := shared.BuildMovieMatchKeysWithCategory(0, "仙逆", 20)[1]
	orphanKey := shared.BuildMovieMatchKeys(0, "查无此片")[0]
	...
	dbKey := shared.BuildMovieMatchKeys(12345, "仙逆")[0]
...
func TestMigrateSlavePlaylistKeys_SameTitleCrossCategoryKeepsIsolation(t *testing.T) {
	...
	keysByMid := shared.LoadMovieMatchKeysByMids([]int64{901, 902})
...
func TestMigrateSlavePlaylistKeys_KeepsNewerTargetPlaylist(t *testing.T) {
	...
	if got := shared.EpisodeCount(links); got != 22 {
...
func TestMigrateSlavePlaylistKeys_KeepsCategoryKeyWhenFilmPidUnresolved(t *testing.T) {
	...
	keys := shared.LoadMovieMatchKeysByMids([]int64{901})[901]
...
func TestMigrateSlavePlaylistKeys_KeepsKeyStillReferencedByPlaylist(t *testing.T) {
	...
	catKey := shared.BuildMovieMatchKeysWithCategory(0, "仙逆", 20)[0]
	plain := shared.BuildMovieMatchKeys(0, "仙逆")[0]
	legacyCat := shared.BuildMovieMatchKeysWithCategory(0, "旧名", 20)[0]
	legacyPlain := shared.BuildMovieMatchKeys(0, "旧名")[0]
